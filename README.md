...
<ul>
  ...
  <li>
    <section>
      ...
      <img src="/Imagens/1-degree_centrality.PNG" max-height="400px">
      <h4>Closeness Centrality</h4>
      <img src="/Imagens/2-closeness_centrality.PNG" max-height="400px">
      <h4>Betwenness Centrality</h4>
      <img src="/Imagens/3-betweenness_centrality.PNG" max-height="400px">
      <h4>Eigenvector Centrality</h4>
      <img src="/Imagens/4-eigenvector_centrality.PNG" max-height="400px">
      <h4>Cumulative Density Function</h4>
      <img src="/Imagens/5-cumulative-density-function.PNG" max-height="400px">
      <h4>Probability Desity Function</h4>
      <img src="/Imagens/6-probability-density_function.PNG" max-height="400px">
      <h4>Indicator comparisons</h4>
      <img src="/Imagens/7-all.PNG" max-height="400px">
      <h4>K-core</h4>
      <img src="/Imagens/8-k-core_sociopatterns.PNG" max-height="400px">    
    </section>
  </li>
</ul>
...
<ul>
  <li>
    <section>
      ...
      <img src="/Imagens/histograma.PNG" max-height="400px">
      <p>
      ...
      <img src="/Imagens/networkGit.PNG" max-height="400px">
    </section>
  </li>
  <li>
    <section>
      ...
      <img src="/Imagens/networkRetina.PNG" max-height="400px">
    </section>
  </li>
  <li>
    <section>
      ...
      <img src="/Imagens/networkGephisto.PNG" max-height="400px">
    </section>
  </li>
<ul>